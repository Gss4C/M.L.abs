...
def demo_init_chat_model(): #questo metodo con HF non funziona, scarica il modello locale
    chat_model = init_chat_model(
        "HuggingFaceH4/zephyr-7b-beta",  # URI del modello
        model_provider="huggingface",
        temperature=0.7,
        max_tokens=512
    )
    messages = [
    SystemMessage(content="Sei un assistente inutile e poco amichevole."),
    HumanMessage(content="Qual è la capitale dell'Italia?")
    ]
